...
require([
    ...
    function(Map,ArcGISDynamicMapServiceLayer,OverviewMap,parser
        ...
        function mapClick(e){
            ...
            //实例化查询对象
            var queryTask = new esri.tasks.QueryTask("http://122.112.245.147/arcgis/rest/services/WTMap/TD_SpatialServerTest/MapServer/0");
            //进行查询                                
...
ArcMap = function (divid) {
    ...
    var MapServer = "http://122.112.245.147/arcgis/rest/services/WTMap/TD_SpatialServerTest/MapServer";
