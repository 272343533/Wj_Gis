...
namespace QyTech.SkinForm.UICreate
{
    public partial class frmList : qyFormWithTitle
    {
        ...
        public bool VisibleBtnAdd { set { tsbAdd.Visible = value; } }
        public bool VisibleBtnEdit { set { tsbEdit.Visible = value; } }
        public bool VisibleBtnDelete { set { tsbDelete.Visible = value; qyDgvList.Columns[0].Visible = value; } }

        public bool VisibleDgvCheckColumn { set { qyDgvList.Columns[0].Visible = value; } }
        ...
        private void GetCurrObj()
        {
            ...
            {
                CurrRowObj = EM_Base.GetByPk<bsUser>(bstable.TPk, currRowObjId);
        ...
        private void tsbAdd_Click(object sender, EventArgs e)
        {
            ...
            frmAdd frmaddobj = new frmAdd(tName, null, EM_App);
